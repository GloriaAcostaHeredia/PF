...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Materias</title>
    ...
    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                //en la tabla de html
                 while ($fila = mysqli_fetch_array($consulta)) {
                    ...
                    echo '<td><a class="btn btn-block btn-warning btn-sm" href="form_mod_materia.php?id='.$id.'">Editar</a><a class="btn btn-block btn-danger btn-sm" href="borrar_materia.php?id='.$id.'">Borrar</a></td>';
                    echo '</tr>';
                    echo '</tbody>';
                }
                ?>

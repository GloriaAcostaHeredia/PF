...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Agregar Carrera</title>
  ...
  <div class="wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Guardar Carrera</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="agregar_carrera.php" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Clave de Carrera:</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="info[clave]" placeholder="Clave" required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Carrera</label>
                        <select name="info[carrera]" class="form-control">
                          <option value="ITI">Ingeniera en Tecnologias de la Informacion</option>
                          <option value="ISA">Ingeniera en Sistemas Automotrices</option>
                          <option value="MECA">Ingeniera en Mecatronica</option>

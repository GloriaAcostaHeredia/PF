...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Agregar Materia</title>
  ...
  <div class="wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Guardar Materia</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="agregar_materia.php" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nombre de Materia:</label>
                    <div class="col-sm-10">

...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Agregar Alumno</title>
  ...
  <div class="wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Guardar alumno</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="agregar_alumno.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="info[matricula]" placeholder="Matricula" required>
                    </div>
                  </div>
                  <div class="form-group row">

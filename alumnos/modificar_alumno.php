<?php
            ...
            $consulta = mysqli_query($conexion, "UPDATE alumnos SET matricula='$matricula', nombre='$nombre', correo='$correo', telefono='$telefono' WHERE id='$id'");
            //se regresa a la tabla incial de html
            header('location: tab_alumnos.php');
        ?>
...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Editar Grupo</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse" style="height: auto;">
  <div class="wrapper">
    ...
    <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="modificar_grupo.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="numgrupo" value="<?php echo $numgrupo; ?>" placeholder="Numero de Grupo" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->

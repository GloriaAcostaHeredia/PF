...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Editar Maestro</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse" style="height: auto;">
  <div class="wrapper">
    ...
    <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="modificar_maestro.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="numemp" value="<?php echo $numemp; ?>" placeholder="Numero de Empleado" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Correo Electronico:</label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" name="correo" value="<?php echo $correo; ?>" placeholder="Correo Electronico" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Telefono:</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="telefono" value="<?php echo $telefono; ?>" placeholder="Telefono" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->

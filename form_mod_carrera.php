...
<html>
  <head>
    ...
    <title>AdminLTE 3 | Editar Carrera</title>
...
<body class="sidebar-mini layout-fixed sidebar-collapse" style="height: auto;">
  <div class="wrapper">
    ...
    <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="modificar_carrera.php" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Clave:</label>
                    <div class="col-sm-10">
                    <input type="hidden"  name="id" value="<?php echo $id; ?>">
                      <input type="number" class="form-control" name="clave" value="<?php echo $clave; ?>" placeholder="Clave" required>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="nombre" class="form-control">
                          <option value="ITI" <?php if ($nombre == 'ITI'){echo 'selected';} ?>>Ingeniera en Tecnologias de la Informacion</option>
                          <option value="ISA" <?php if ($nombre == 'ISA'){echo 'selected';} ?>>Ingeniera en Sistemas Automotrices</option>
                          <option value="MECA" <?php if ($nombre == 'MECA'){echo 'selected';} ?>>Ingeniera en Mecatronica</option>
                          <option value="LAyGE" <?php if ($nombre == 'LAyGE'){echo 'selected';} ?>>Licenciatura en Administracion y Gestion Empresarial</option>
                        </select>
                      </div>
                    </div>
                <!-- /.card-body -->
